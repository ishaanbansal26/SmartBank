            ...
            builder.Services.AddCors(options =>
            {
                options.AddPolicy("AllowFrontend",
                    policy => policy
                        ...
                        .AllowAnyOrigin() //whether it is from any server like angular or react
                        .AllowAnyHeader() //can be json or xml header
                        .AllowAnyMethod()); //can be any method get post put etc
            });
